...
public class TestConnection {
	...
	public static Boolean test() {
		...
		try {
			...
			//Cookie: MEM%5FID=80100900; MEM%5FPASS=yungyung60%21; ASPSESSIONIDQGCRQSQR=JPFAEPCACJLJAEAHAHDJCPEM
			...
			System.out.println(reservePageDocument.toString());
			
			String requestURL = "https://www.ownersgc.co.kr/html/member/login_ok.asp";
			...
			if (response1.getStatusLine().getStatusCode() == 200) {
				...
				System.out.println("response is error : " + response1.getStatusLine().getStatusCode());
				bSucc = false;
			}
		} catch (Exception e){
